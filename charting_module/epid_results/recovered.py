...
def recovered_plot(
    ...
    plt.savefig(save_path + f'REC_{city}_{method}_{regim}_{st_time}_{end_time}.png', dpi=600)
    plt.savefig(save_path + f'REC_{city}_{method}_{regim}_{st_time}_{end_time}.pdf', dpi=600)
    plt.clf()